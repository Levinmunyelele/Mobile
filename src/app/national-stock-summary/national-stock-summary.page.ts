...
@Component({
  selector: 'app-national-stock-summary',
  templateUrl: './national-stock-summary.page.html',
  styleUrls: ['./national-stock-summary.page.scss'],
})
export class NationalStockSummaryPage implements OnInit {
   inventoryDataById: { [key: string]: any } = {};
    ...
    goBack() {
      this.router.navigate(['national-stock-reports']);
    }
