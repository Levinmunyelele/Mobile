...
@Component({
  selector: 'app-county-stock-summary',
  templateUrl: './county-stock-summary.page.html',
  styleUrls: ['./county-stock-summary.page.scss'],
})
export class CountyStockSummaryPage implements OnInit {
   ...
   inventoryDataById: { [key: string]: any } = {};
    ...
    goBack() {
      this.router.navigate(['county-stock-reports']);
    }
